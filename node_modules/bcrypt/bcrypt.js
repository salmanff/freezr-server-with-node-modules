...
module.exports.compareSync = function(data, hash) {
    ...
    if (bindings.compare_sync(data, hash)) {
        console.log("compareSync matched !!!");
    } else {
        console.log("compareSync Password NOT matched !!!");
    }
...
module.exports.compare = function(data, hash, cb) {
    console.log("in bcrypt checking data hash "+JSON.stringify(data)+" hash "+hash);
    if (data == null || hash == null) {
    ...
    if (bindings.compare(data, hash, cb)) {
        console.log("compare matched !!!");
        return true;
    } else {
        console.log("compare Password NOT matched !!! hash "+hash+" - data:"+JSON.stringify(data));
        return false;
    }
